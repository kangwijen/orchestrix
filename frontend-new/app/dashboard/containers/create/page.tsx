...
const containerSchema = z.object({
  imageName: z
    ...
    .regex(/^[a-zA-Z0-9_./-]+:[a-zA-Z0-9_./-]+$/, "Invalid image name format. Use format: name:tag"),
  containerName: z
    .string()
  ...
  portMappings: z.array(
    z.object({
      ...
      {
        message: "Both host port and container port must be filled or both must be empty",
        path: ["containerPort"],
      }
    ),
  ),
    ...
    <div className="flex w-full flex-col gap-3 pb-6 sm:gap-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure the settings for your new container</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col">
                      ...
                      <p className="text-muted-foreground text-sm">Format: name:tag (e.g., nginx:latest)</p>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                {portFields.map((field, index) => (
                  <div key={field.id} className="flex items-start gap-2">
                    ...
                    <Button
                      ...
                      variant="ghost"
                      size="icon"
                      className="h-9 w-9 mt-5 flex-shrink-0"
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Button type="button" onClick={() => appendEnv({ key: "", value: "" })} variant="outline" size="sm">
                    <Plus className="mr-2 h-4 w-4" />
                    Add Variable
                  </Button>
                </div>
